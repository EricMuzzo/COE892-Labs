...
def init_rover(rover_id: int) -> Rover:
    ...
    print(f"Commands received and processed: {commands}")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Failed to establish communication with server")
        exit()
    ...
    #=================================================================
    rover = init_rover(id)
    print(f"Rover {rover.id} initialized")
